...
MySQL - 10.1.9-MariaDB-log : Database - php_mbi
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`php_mbi` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `tasks` (
  ...
  `description` text,
  `status` enum('New','In Progress','On Hold','Cancelled','Done') DEFAULT 'New',
